...
export class AuctionofferViewComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private http: HttpClient, private router: Router, private auctionView:  AuctionViewService) {
  ...
  onSubmit(offerId) {
    this.auctionView.selectOffer(this.id, offerId).subscribe(data => {
